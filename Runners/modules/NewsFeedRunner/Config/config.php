...
return [
    ...
    'quote-based-providers' => array_map('intval', explode(',',  env('NEWS_FEED_QUOTE_BASED_PROVIDERS', '13'))),

    'quote-based-feeds' => array_map('intval', explode(',',  env('NEWS_FEED_QUOTE_BASED_FEEDS', '23'))),
